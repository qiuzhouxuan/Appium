...
from wuhan_appium.webdriver.mobilecommand import MobileCommand as Command

if TYPE_CHECKING:
    from wuhan_appium.webdriver.common.touch_action import TouchAction
    from wuhan_appium.webdriver.webdriver import WebDriver
    from wuhan_appium.webdriver.webelement import WebElement
